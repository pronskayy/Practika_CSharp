...
namespace Day15.Services
{
    public class EmployeeService
    {
        ...
        private List<Employee> _employees;   // ← здесь должно быть _employees, а не _users
        ...
        private void SaveEmployees()
        {
            ...
            // ВНИМАНИЕ: здесь должно быть _employees, а не _users!
            var json = JsonConvert.SerializeObject(_employees, Newtonsoft.Json.Formatting.Indented);
